	...
	var Weather = React.createClass({
	  ...
	  render: function render() {
	    ...
	    function renderMessage() {
	      ...
	      } else if (temp && location) return React.createElement(WeatherMessage, { temp: temp, location: location });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Open_Weather_Map_Url = 'http://api.openweathermap.org/data/2.5/weather?appid=3e6184d3b5a7e11052c1124d03ce6236&units=metric';
